...
\begin{figure*}[h!]
	...
	\begin{tikzpicture}[
		...
		\begin{axis}[every axis plot post/.append style={
 					 ...
 					 xtick={1.5}, xticklabels={x}, 
 					 enlargelimits=upper] 
  			\addplot {gauss(2,0.75,0)};
  			\addplot +[black, dashed, mark=none] coordinates {(1.5, 0) (1.5, 0.423)};
	...
	\begin{tikzpicture}[
		...
		\begin{axis}[every axis plot post/.append style={
  					 ...
  					 xticklabels={\overline{x}}, xtick={0.0001}, 
  					 xticklabels={x}, enlargelimits=upper] 
  			\addplot {gauss(2,2.75,0.15)};
  			\addplot +[black, dashed, mark=none] coordinates {(0.0001, -0.145) (0.0001, -0.039)};
		\end{axis}
	\end{tikzpicture}
\end{figure*}
