...
Wir haben hier unterschiedliche Bietfunktionen, also ein \textbf{asymmetrisches Gleichgewicht}. Zusätzlich liegt hier keine Effizienz mehr vor, denn $\beta_{2}$ ist an den markierten Stellen trotz niedrigerem Signal höher! $\Rightarrow$ RAT gilt nicht mehr.
\end{beispiel}
